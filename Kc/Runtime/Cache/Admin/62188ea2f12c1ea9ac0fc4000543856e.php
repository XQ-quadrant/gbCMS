...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
	...
	<!-- Graph CSS -->
	<link href="/kechuang4/Public/Bootstrap/css/lines.css" rel='stylesheet' type='text/css' />
...
<div id="wrapper">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="m_2"><a href="/kechuang4/index.php/Admin/Enter/logout"><i class="fa fa-lock"></i> 退 出 </a></li>
                </ul>
            </li>
        </ul>
			...
			<div class="activity_box">
				<div class="scrollbar" id="style-2">
					<div class="activity-row">
						...
						<div class="col-xs-3 activity-img"><img src='/kechuang4/Public/Bootstrap/images/5.png' class="img-responsive" alt=""/></div>
					...
					<div class="activity-row">
						...
						<div class="col-xs-3 activity-img"><img src='/kechuang4/Public/Bootstrap/images/3.png' class="img-responsive" alt=""/></div>
						<div class="col-xs-8 activity-desc">
					...
					<div class="activity-row">
						...
						<div class="col-xs-3 activity-img"><img src='/kechuang4/Public/Bootstrap/images/1.png' class="img-responsive" alt=""/></div>
						<div class="col-xs-8 activity-desc">
					...
					<div class="activity-row1">
						...
						<div class="col-xs-3 activity-img"><img src='/kechuang4/Public/Bootstrap/images/4.png' class="img-responsive" alt=""/></div>
						<div class="col-xs-8 activity-desc">
	...
	<div class="span_11">
		<div class="col-md-6 col_4">
			...
			<!----Calender -------->
			<link rel="stylesheet" href="/kechuang4/Public/Bootstrap/css/clndr.css" type="text/css" />
			<script src="/kechuang4/Public/Bootstrap/js/underscore-min.js" type="text/javascript"></script>
			<script src= "/kechuang4/Public/Bootstrap/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="/kechuang4/Public/Bootstrap/js/clndr.js" type="text/javascript"></script>
			<script src="/kechuang4/Public/Bootstrap/js/site.js" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
		<div class="col-md-6 col_5">
			...
			<!-- map -->
			<link href="/kechuang4/Public/Bootstrap/css/jqvmap.css" rel='stylesheet' type='text/css' />
			<script src="/kechuang4/Public/Bootstrap/js/jquery.vmap.js"></script>
			<script src="/kechuang4/Public/Bootstrap/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
			<script src="/kechuang4/Public/Bootstrap/js/jquery.vmap.world.js" type="text/javascript"></script>
